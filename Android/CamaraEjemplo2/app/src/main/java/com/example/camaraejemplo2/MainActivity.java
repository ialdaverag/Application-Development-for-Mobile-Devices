package com.example.camaraejemplo2;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle b){
        ...
        s = Environment.getExternalStorageDirectory() + "/test.jpg"; jbn = (Button)findViewById(R.id.xbn1);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == TAKE_PICTURE) {
            ...
            try {
                ...
                ImageView iv = (ImageView)findViewById(R.id.xiv1);
                iv.setImageBitmap(bitmap); } catch (FileNotFoundException e) {}
        }
    }
}